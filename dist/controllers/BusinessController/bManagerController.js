...
exports.updateBusinessManager = exports.getBusinessManager = exports.addBusinessManager = void 0;
...
const addBusinessManager = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        if (req.files) {
            ...
            let newManager = new businessManager_1.default({
                businessId,
                name,
                email,
            ...
            newManager = yield newManager.save();
            if (!newManager) {
...
exports.addBusinessManager = addBusinessManager;
const getBusinessManager = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    try {
        const data = yield businessManager_1.default.find({ businessId: id });
        if (data.length === 0) {
...
const updateBusinessManager = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        const data = yield businessManager_1.default.findOneAndUpdate({ businessId }, {
            name,
            email,
            role,
            image,
...
exports.updateBusinessManager = updateBusinessManager;
