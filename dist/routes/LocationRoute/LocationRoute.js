...
router.post("/importsudur", fileUpload_1.default.single("file"), location_1.importsudur);
router.post("/importlumbini", fileUpload_1.default.single("file"), location_1.importLumbini);
router.post("/importgandaki", fileUpload_1.default.single("file"), location_1.importGandaki);
router.post("/import1", fileUpload_1.default.single("file"), location_1.importprov1);
router.post("/import2", fileUpload_1.default.single("file"), location_1.importprov2);
router.post("/importkarnali", fileUpload_1.default.single("file"), location_1.importkarnali);
